...
function isTimeInDisabledRange(time, _a2) {
  ...
  var valid;
  try {
    valid = !isWithinInterval(baseTime, { start: min2, end: max3 });
  } catch (err) {
    valid = false;
  }
  return valid;
    ...
    function Calendar2(props) {
      ...
      _this.header = function(date) {
        ...
        return dayNames.concat([0, 1, 2, 3, 4, 5, 6].map(function(offset3) {
          ...
          return import_react4.default.createElement("div", { key: offset3, "aria-label": formatDate(day, "EEEE", _this.props.locale), className: clsx("react-datepicker__day-name", weekDayClassName) }, weekDayName);
        }));
      };
  ...
  function(_super) {
    ...
    function DatePicker2(props) {
      ...
      _this.setSelected = function(date, event, keepInput, monthSelectedIn) {
        ...
        if (!isEqual2(_this.props.selected, changedDate) || _this.props.allowSameDay || selectsRange || selectsMultiple) {
          ...
          if (selectsRange) {
            ...
            if (noRanges) {
              onChange ? onChange([changedDate, null], event) : DatePicker2.defaultProps.onChange;
            } else if (hasStartRange) {
              if (changedDate === null) {
                onChange ? onChange([null, null], event) : DatePicker2.defaultProps.onChange;
              } else if (isDateBefore(changedDate, startDate)) {
                if (swapRange) {
                  onChange ? onChange([changedDate, startDate], event) : DatePicker2.defaultProps.onChange;
                } else {
                  onChange ? onChange([changedDate, null], event) : DatePicker2.defaultProps.onChange;
                }
              } else {
                onChange ? onChange([startDate, changedDate], event) : DatePicker2.defaultProps.onChange;
              }
            }
            if (isRangeFilled) {
              onChange ? onChange([changedDate, null], event) : DatePicker2.defaultProps.onChange;
            ...
            if (changedDate !== null) {
              if (!(selectedDates === null || selectedDates === void 0 ? void 0 : selectedDates.length)) {
                onChange ? onChange([changedDate], event) : DatePicker2.defaultProps.onChange;
              } else {
                ...
                if (isChangedDateAlreadySelected) {
                  ...
                  onChange ? onChange(nextDates, event) : DatePicker2.defaultProps.onChange;
                } else {
                  onChange ? onChange(__spreadArray(__spreadArray([], selectedDates, true), [changedDate], false), event) : DatePicker2.defaultProps.onChange;
                }
              }
            }
          } else {
        ...
        if (!keepInput) {
          var onSelect = (_a2 = _this.props.onSelect) !== null && _a2 !== void 0 ? _a2 : DatePicker2.defaultProps.onSelect;
      ...
      _this.handleTimeChange = function(time) {
        ...
        var onChange = (_a2 = _this.props.onChange) !== null && _a2 !== void 0 ? _a2 : DatePicker2.defaultProps.onChange;
      ...
      _this.onClearClick = function(event) {
        ...
        if (selectsRange) {
          ...
          onChange ? onChange(null, event) : DatePicker2.defaultProps.onChange();
        }
        _this.setState({ inputValue: null });
      };
