            ...
            <div className="navbar-wrapper">
                <div className="m-header">
                    <Link to="/" className="b-brand">
                        ...
                        <img style={{width:"100%"}} src="/images/icons/waystopay-full.png" alt="logo" className="logo logo-lg" />
                        <img src="/images/icons/waystopay.png" alt="logo" className="logo logo-sm" />
                    </Link>
                </div>
