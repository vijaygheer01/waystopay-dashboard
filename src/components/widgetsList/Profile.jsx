...
import { FiEdit, FiMail, FiMapPin, FiPhone, FiTrash2 ,FiDollarSign} from 'react-icons/fi'
const Profile = ({ user,walletBalance }) => {
    return (
        ...
        <div className="card stretch stretch-full">
            ...
            <li className="hstack justify-content-between mb-4">
                <span className="text-muted fw-medium hstack gap-3"><FiDollarSign size={16} />Wallet Balance</span>
                <span className="float-end badge bg-primary fw-bold">{walletBalance?.value ? `$${walletBalance?.value}` : 'N/A'}</span>
            </li>
            </div>
        </div>
